...
def _infer_copy_purpose(instruction: str) -> str:
    ...
    for keyword, purpose in mapping:
        if keyword.lower() in normalized_instruction:
            return purpose
...
_MAIN_IMAGE_COPY = "Extract supportable main-image value. Use a concise headline and up to three benefit points."
_MAIN_IMAGE_INSTRUCTION = "Create a clean product-focused ecommerce main image with supported benefits."
...
_MULTI_ANGLE_COPY = "Plan a multi-angle sequence covering front, side, back, or key structure. Keep notes short."
_MULTI_ANGLE_IMAGE = "Create a multi-angle product image with consistent proportions and clear detail-page angles."

_SKU_COPY = "Write short SKU difference notes for color, spec, capacity, or bundle comparison."
_SKU_IMAGE = "Create a product image that shows SKU differences while keeping the subject consistent."

_FEATURE_INFOGRAPHIC_COPY = "Extract three to five supportable feature points with short labels and visual suggestions."
_FEATURE_INFOGRAPHIC_IMAGE = "Create a product feature infographic with a clear subject and hierarchical layout."

_SIZE_SPEC_COPY = "Organize supplied size, capacity, spec, material, and caution facts into short copy."
_SIZE_SPEC_IMAGE = "Create a size/spec explainer with product outline, annotation areas, and clear layout."

_SCALE_REFERENCE_COPY = "Describe product scale with supplied facts and plausible references. Avoid exaggeration."
_SCALE_REFERENCE_IMAGE = "Create a realistic scale-reference image for size, thickness, or capacity."

_PACKAGE_COPY = "Organize supplied package contents, accessories, gifts, and unboxing state into labels."
_PACKAGE_IMAGE = "Create a package/checklist flat-lay showing product, box, accessories, and quantities."

_USAGE_STEPS_COPY = "Break supplied installation, unboxing, wearing, cleaning, or usage facts into 3-4 steps."
_USAGE_STEPS_IMAGE = "Create a usage-steps explainer with clear order, realistic actions, and product parts."

_COMPARISON_COPY = "Extract supportable comparison dimensions for versions, alternatives, or bundles."
_COMPARISON_IMAGE = "Create a comparison image showing verifiable spec, feature, or usage differences."

_LIFESTYLE_COPY = "Extract target audience, usage scene, and lifestyle mood from supplied facts."
_LIFESTYLE_IMAGE = "Create a natural lifestyle image with the product clear in a realistic usage scene."

_SCENE_COPY = "Extract suitable usage scenes, matching objects, and environment keywords from supplied product facts."
_SCENE_IMAGE = "Create a credible usage-scene image with the product as the visual subject."

_DETAIL_COPY = "Extract supplied material, craft, structure, and function details into short copy."
_DETAIL_IMAGE = "Create a detail/material close-up emphasizing texture and supportable feature points."

_CAMPAIGN_COPY = "Generate campaign copy only from supplied offer, timing, and benefit facts."
_CAMPAIGN_IMAGE = "Create a campaign product image with clear subject, atmosphere, and hierarchy."

_SHORT_VIDEO_COVER_COPY = "Create one supportable short-video cover hook and two supporting points when facts allow."
_SHORT_VIDEO_COVER_IMAGE = "Create a vertical short-video cover with a prominent subject and hook area."
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=1280,
                y=180,
                instruction_seed="Refine subject clarity, lighting, and composition for a comparable version.",
                size="1024x1024",
            ),
            _node(
                "refined_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=680,
                y=180,
                instruction_seed="Create a side or 45-degree view with consistent proportions and material.",
                size="1024x1024",
            ),
            _node(
                "side_output",
            ...
            _node(
                ...
                x=680,
                y=312,
                instruction_seed="Create a back, bottom, or key-structure view with realistic proportions.",
                size="1024x1024",
            ),
            _node(
                "back_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=224,
                instruction_seed="Create a SKU comparison image with consistent view and unified lighting.",
                size="1536x1024",
            ),
            _node(
                "variant_grid_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=340,
                y=244,
                instruction_seed="Organize feature points into headline, labels, annotations, and whitespace.",
            ),
            _node(
                "infographic",
                WorkflowNodeType.IMAGE_GENERATION,
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=680,
                y=236,
                instruction_seed="Create a readable parameter explainer from supplied specs and cautions.",
                size="1024x1536",
            ),
            _node(
                "spec_table_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=710,
                y=244,
                instruction_seed="Create a scale-reference image in realistic context. Avoid exaggerated proportions.",
                size="1536x1024",
            ),
            _node(
                "surface_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=252,
                instruction_seed="Create an unboxing/gift/received-package image with clear package and accessories.",
                size="1024x1024",
            ),
            _node(
                "gift_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=360,
                y=292,
                instruction_seed="Add short notes for supplied usage cautions, limits, cleaning, or safety.",
            ),
            _node(
                "tip_image",
                WorkflowNodeType.IMAGE_GENERATION,
                ...
                x=700,
                y=292,
                instruction_seed="Create a caution explainer with visuals and short labels.",
                size="1024x1024",
            ),
            _node(
                "tip_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=248,
                instruction_seed="Create an explainer for upgrade or bundle differences using verifiable facts.",
                size="1024x1024",
            ),
            _node(
                "upgrade_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=224,
                instruction_seed="Create an image emphasizing action, texture, or wearing details with product clear.",
                size="1024x1536",
            ),
            _node(
                "detail_usage_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=236,
                instruction_seed="Create a structure/craft explainer with understandable relationships.",
                size="1024x1024",
            ),
            _node(
                "structure_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=360,
                y=224,
                instruction_seed="Organize campaign hierarchy: product, benefits, mood, and whitespace.",
            ),
            _node(
                "banner",
                WorkflowNodeType.IMAGE_GENERATION,
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=360,
                y=244,
                instruction_seed="Organize cover rhythm: close-up, usage moment, title area, and whitespace.",
            ),
            _node(
                "vertical_cover",
                WorkflowNodeType.IMAGE_GENERATION,
            ...
            _node(
                ...
                x=720,
                y=276,
                instruction_seed="Create an alternate cover focused on product close-up and usage moment.",
                size="1024x1536",
            ),
            _node(
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=248,
                instruction_seed="Create a light-shadow product display on pale gray or white background.",
                size="1024x1024",
            ),
            _node(
                "shadow_output",
